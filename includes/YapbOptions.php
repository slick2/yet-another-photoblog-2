<?php
	...
	$this->options = array(
		...
		array(__('Yet Another Photoblog Options', 'yapb'), '',
	...
	/* 						array(__('Image Resizing on upload','yapb'), '',
				...
				array('Feeds', __('YAPB may embed images/thumbnails in your RSS2 and ATOM feeds. You will have to turn on this feature if you want to subscribe to services like <a href="http://photos.vfxy.com" target="_blank">VFXY</a>.', 'yapb'),
					array(
						'yapb_display_images_xml' => array('CHECKBOX', __('<strong>Embed images in RSS2 and ATOM feeds content.</strong>', 'yapb'), true),
						'yapb_display_images_xml_thumbnail' => array('CHECKBOX_INPUT', __('Display as thumbnail with a width of #3 px', 'yapb'), array(true, '180')),
		...
		array(__('Thumbnailer Library Options', 'yapb'), __('<a href="http://phpthumb.sourceforge.net/" target="_blank">phpThumb</a> is the thumbnailing library of my choice. For your comfort, i made available a selection of settings. For more Information refer to <a href="http://phpthumb.sourceforge.net/" target="_blank">http://phpthumb.sourceforge.net/</a>.', 'yapb'),
			array(
				array(__('ImageMagick configuration', 'yapb'), __('If source image is larger than available memory limits AND ImageMagick\'s "convert" program is available on your server (<a href="http://www.imagemagick.org" target="_blank">more info</a>), phpThumb() will call ImageMagick to perform the thumbnailing of the source image to bypass the memory limitation.', 'yapb'),
					array(
		...
		array(__('Automatic Template Insertion', 'yapb'), '',
			array(
				array(__('General', 'yapb'), __('Yapb does display uploaded images automatically on different sections of your site by default.<br />This is NOT exactly what i thought of when i designed and programmed YAPB - It\'s just a help for first-time-users.<br />To style your photoblog individually, turn off this option and have a look at <a target="_blank" href="http://johannes.jarolim.com/blog/wordpress/yet-another-photoblog/adapting-templates/">how to adapt themes manually</a>.', 'yapb'),
					array(
